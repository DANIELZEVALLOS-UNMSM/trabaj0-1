...
Z = [182.4 178.9 175.1 171.0 166.8 162.7 158.9 ...
    155.4 152.0 149.0 146.1 145.2 145.8 147.3 ...
    149.9 153.5 158.0 163.2 168.9 174.8 180.5 ...
    186.2 191.5 196.2 200.1 203.1 205.2 206.3 ...
    206.1 204.7 198.0 194.4 190.9 187.8 185.1 ...
    183.0 181.6 180.8 180.6 180.9];

% SPLINE
x = linspace(10,107.5,500);

Vspline = spline(f,V,x);
Zspline = spline(f,Z,x);
...
title('Comportamiento de V(f)')
xlabel('Frecuencia (kHz)')
ylabel('Voltaje V')

legend('Datos','Spline')

% GRAFICA DE IMPEDANCIA
figure

plot(f,Z,'ko')
hold on

plot(x,Zspline,'b','LineWidth',2)

grid on

title('Comportamiento de |Z(f)|')
xlabel('Frecuencia (kHz)')
ylabel('Impedancia |Z|')
